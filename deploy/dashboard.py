...
with tabs[5]:
    ...
    st.markdown(
        """
1. Investasi perbaikan pada proses online boarding (kemudahan proses check-in/boarding digital) berpotensi memberikan dampak signifikan terhadap peningkatan kepuasan penumpang, karena merupakan salah satu prediktor terkuat setelah rating layanan komposit.
